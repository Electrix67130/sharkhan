    ...
    ({
        ...
        headerAboveBarMobile: function() {
            if (e(".above-header").length > 0) {
                ...
                !i.children().length > 0 ? (i.hide(), s.hide()) : (s.show(), i.clone().appendTo(".header-above-bar"), a.on("click", function(e) {
                    t.toggleClass("is-active"), a.toggleClass("is-active"), e.preventDefault()
                })), this.headerAboveAccessibility()
            } else if ( $(".header-above-wrapper").children().length > 0 ) {
              $(".header-above-btn").hide();
            } else {
              $(".header-above-btn").show();
            }
        },
